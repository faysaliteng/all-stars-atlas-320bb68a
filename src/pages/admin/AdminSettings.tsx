...
const apiIntegrations = [
  ...
  { id: 'email_resend', name: 'Resend (Email API)', description: 'Transactional emails — booking confirmations, OTP, invoices', fields: [{ key: 'enabled', label: 'Enabled', placeholder: '', type: 'select', options: ['true', 'false'] }, { key: 'api_key', label: 'API Key', placeholder: 're_xxxxxxxxxxxx', type: 'password' }, { key: 'from_email', label: 'From Address', placeholder: 'Seven Trip <noreply@seventrip.com.bd>', type: 'text' }], docs: 'https://resend.com/docs', category: 'communication' },
...
const AdminSettings = () => {
  ...
  const [generalForm, setGeneralForm] = useState({ siteName: 'Seven Trip', supportEmail: 'support@seventrip.com.bd', currency: 'bdt', language: 'en' });
