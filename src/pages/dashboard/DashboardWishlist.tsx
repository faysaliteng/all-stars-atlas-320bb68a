...
const STORE_KEY = "dashboard_wishlist";
...
const DashboardWishlist = () => {
  ...
  const [items, setItems] = useState(() => getCollection(STORE_KEY, mockWishlist.items));

  const removeItem = (id: string) => {
    const updated = removeFromCollection(STORE_KEY, mockWishlist.items, id);
    setItems([...updated]);
